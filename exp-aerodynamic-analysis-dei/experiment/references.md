...
3. **NASA Technical Note D-8236**, "Aerodynamic Characteristics of Bluff Bodies," National Aeronautics and Space Administration, Washington, DC, 1976.  
   *(Provides drag coefficient data for various bluff body shapes, including the X-frame configuration used in Sub-Calc B).*
...
6. **M. Drela**, "QPROP: Formulation for Second-Order Propeller/Windmill Analysis," MIT Department of Aeronautics and Astronautics, Cambridge, MA, Tech. Rep. MIT-Aero-2007-1, 2007.  
   *(Outlines numerical methods for modeling small UAV-scale propellers operating in low Reynolds number regimes).*